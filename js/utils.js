...
function getNewsList() {
    return [
    "欢迎来到TYPE TREE，作者不愿意透露姓名",
    "有哪个作者直接做第八层啊，原来是我",
    "对不起对CS设了",
    "typetree将于6月31号开始免费花分文",
    "补丁数是负的，最大值为0，当补丁用完时，会跳转到下一版本",
    "宝宝巴士，快乐启蒙",
    "你们知道吗，其实先点击4次HS再点击4次CS，就会跳转到Pornhub，不需要梯子，但是他会在0.001s后变回去",
    "niko",
    "我教你一招，先把EP煎熟，这样你就能煎熟Eff了",
    "谨防诈骗小妙招：关于历史的那个加成前六层的并非叫烹饪",
    "先下UN和KB，加几勺T，再来几克Ol，就可以腌制了，腌制完成后锅底抹点Eff，炒的过程中再加点C，出锅后加点CS就可以吃了",
    "喵呜~",
    "肯的鸡Typetree套餐：Re，IN，炸EL，MH",
    ]
}